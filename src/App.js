...
const Top100Archive = () => {
  ...
  // Your tab & range (headers in row 1). Space is fine—we URL-encode it.
  ...
  // High-contrast row styling with priority
  ...
  // Position pill styling—mirrors the same priority
  const getPositionBadge = (position, division) => {
    const pos = parseInt(position || 0, 10);
    const div = parseInt(division || 0, 10);

    // Auto-sacked strongest
    if (pos >= 18 && pos <= 20)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-8">
              ...
              <div className="text-center p-4 bg-white bg-opacity-10 rounded-lg backdrop-blur">
                <div className="text-3xl font-bold text-purple-400">
                  {allPositionData.length.toLocaleString() || '2,500+'}
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
              ...
              <div className="text-center py-16">
                <div className="bg-white rounded-2xl p-12 shadow-xl max-w-2xl mx-auto">
                  ...
                  <p className="text-gray-600 mb-6">
                    Configure your Google Sheets API to access 25+ seasons of Top 100 data
                  </p>
                  <button
              ...
              <div className="text-center py-16">
                <div className="bg-white rounded-2xl p-12 shadow-xl max-w-2xl mx-auto">
                  ...
                  <p className="text-gray-600 mb-4">
                    Explore {allPositionData.length.toLocaleString()} position records across {availableSeasons.length}{' '}
                    seasons
                  </p>
        ...
        {activeTab === 'statistics' && <StatisticsPanel dataLoaded={dataLoaded} allPositionData={allPositionData} availableSeasons={availableSeasons} />}
  ...
  <div className="space-y-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <StatsCard
        ...
        color="blue"
      />
      <StatsCard icon={Calendar} title="Historical Seasons" value={availableSeasons.length || 0} subtitle="Complete coverage" color="green" />
      <StatsCard
        icon={Users}
        title="Total Records"
