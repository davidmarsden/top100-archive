    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <nav className="flex flex-wrap gap-x-5 gap-y-3 text-sm font-semibold" aria-label="Top 100 footer navigation">
          <a href="https://smtop100.blog/" className="text-slate-300 no-underline hover:text-white">Top 100</a>
          <a href="https://smtop100.blog/rules/" className="text-slate-300 no-underline hover:text-white">Rules</a>
          <a href="https://smtop100.blog/support/" className="text-slate-300 no-underline hover:text-white">Support</a>
